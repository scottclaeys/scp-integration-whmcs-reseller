...
class UsageFormatter
{
    ...
    public function humanToBits($size)
    {
        if (!$size) {
            return 0;
        }
    ...
    public function megaBytesToHuman($megaBytes, $precision = 2, $default = '0B')
    {
    ...
    public function bitsToHuman($bits, $precision = 2, $default = '0B')
    {
